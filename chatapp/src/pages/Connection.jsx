...
import {Users,UserPlus,UserRoundPen,UserCheck,MessageSquare} from 'lucide-react'
...
const Connection = () => {
  ...
  const [currentTab,setCurrentTab] = useState('Follwers')
  const dataArray = [
        ...
        <div className="mb-8 flex flex-wrap gap-6">
          {
             dataArray.map((item,index)=>(
              <div key={index} className="flex flex-xol items-center justify-center gap-1 border h-20 w-40 border-gray-200 bg-white shadow rounded-md">
